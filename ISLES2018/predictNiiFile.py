...
import glob
#import sys
#sys.path.append('/raid/Saqib/ISLES2018/code')
#from utils import weighted_dice_coefficient_loss,  dice_coefficient

config = dict()
# directories
config["output_foder"] = os.path.abspath("/raid/Saqib/ISLES_dataset/output/EXP12/")  # outputs path
config["data_folder"] = os.path.abspath("/raid/Saqib/ISLES_dataset/TRAIN/") #path to training data
...
if config["test_data"]==True:
    config["data_folder"] = os.path.abspath("/raid/Saqib/ISLES_dataset/TEST_DATA/")
